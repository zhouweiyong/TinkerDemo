...
import com.vst.tinkerdemo.tinker.Log.MyLogImp;
import com.vst.tinkerdemo.tinker.utils.TinkerManager;

/**
 * Created by zwy on 2018/3/14.
 * email:16681805@qq.com
 */

@SuppressWarnings("unused")
@DefaultLifeCycle(application = "com.vst.tinkerdemo.MyApplication",// application类名。只能用字符串，这个MyApplication文件是不存在的，但可以在AndroidManifest.xml的application标签上使用（name）
...
public class TinkerApplicationLike extends DefaultApplicationLike {
    ...
    public void initTinker(Context base) {
        // tinker需要你开启MultiDex
